...
def write_isolated_script():
    ...
    # Create a completely isolated script that doesn't import anything from our project
...
"""
    ...
    # Write the isolated script to a file
    script_path = os.path.join("data", "isolated_bot.py")
...
def run_isolated_bot():
    ...
    print("=" * 60)
    print(" COMPLETELY ISOLATED TRADING BOT LAUNCHER")
    print("=" * 60)
    
    # Write the isolated script
    script_path = write_isolated_script()
    print(f"\nCreated isolated bot script at: {script_path}")
    
    # Launch the bot in its own process
