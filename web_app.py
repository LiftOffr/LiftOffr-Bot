...
def api_status():
    """
    API endpoint for getting all bot statuses
    """
    global bot_manager
...
def run_web_app(manager: BotManager):
    """
    Run the web app with the given bot manager
...
if __name__ == '__main__':
    # This is for running the web app directly (for testing)
